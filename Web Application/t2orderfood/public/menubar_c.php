    ...
    <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold">
                    <a href="dashboard_c.php" class="waves-effect waves-cyan">
...
<!--         <div id="push-notification" class="modal">
            ...
            <div class="modal-content">
                <h4>Information</h4>
                <hr>
                <p>Push notification sent from firebase console account, click continue to redirect to your firebase console account</p>
            </div>
