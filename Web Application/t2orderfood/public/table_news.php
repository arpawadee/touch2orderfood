          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">News List</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">Dashboard</a>
		                  </li>
		                  <li><a href="#" class="active">Manage News</a>
		                  </li>
		                </ol>
              		</div>
            	</div>
				                	...
				                	<tr>
				                		<td width="25%">
				                			<div class="input-field col s12">
							                    <a href="add-news.php" class="btn waves-effect waves-light indigo">Add New News</a>
							                </div>
				                		</td>
				                		<td width="40%">
				                			<div class="input-field col s12">
		                    		...
		                    		<div class="input-field col s12">
										...
										<thead>
											...
											<?php 
												...
												<tbody>
													<tr>
														<td width="40%"><?php echo $data['news_heading'];?></td>
														<td><img src="upload/news/thumbs/<?php echo $data['news_image']; ?>" width="50" height="50"/></td>
